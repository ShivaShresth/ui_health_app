    ...
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            children: [
              Text("Select Your Category!",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
              SizedBox(
                height: 20,
              ),
              Container(
                width: 320,
                child: Text(
                    "Your exerciese will be curated according to the category that you have selected."),
              ),
SizedBox(height: 16,),
                ...
                child: Row(
                  children: List.generate(6, (index) {
                    return GestureDetector(
                      onTap: (){ 
                        if(_isFirstSectionSelected && _isSecondSectionSelected && _isThirdSectionSelected==true){  
                        _onTileTap(index);
                            ...
                            indicator: Container(
                              decoration: BoxDecoration(
                                ...
                                color: _pressedIndices.contains(index)
                                    ? Colors.black
                                    :( _isFirstSectionSelected && _isSecondSectionSelected && _isThirdSectionSelected)?_getIndicatorColor(index) : Colors.grey,
                              ),
